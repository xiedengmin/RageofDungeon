...
namespace ET
{
	...
	{
		public const string BuildOutputDir = "./Bin/Debug";
		...
		public static Node LoadAssetAtPath(string s)
		{
#if UNITY_EDITOR	
			return GodotEditor.AssetDatabase.LoadAssetAtPath<Node>(s);
#else
			return null;
#endif
		}
		...
		{
#if UNITY_EDITOR	
			return GodotEditor.AssetDatabase.GetAssetPathsFromAssetBundle(assetBundleName);
#else
			return new string[0];
#endif
		}
		...
		{
#if UNITY_EDITOR	
			return GodotEditor.AssetDatabase.GetAssetBundleDependencies(assetBundleName, v);
#else
			return new string[0];
#endif
		}
