...
namespace ET.Client
{
    ...
    public static class ResourcesComponentSystem
    {
        ...
        public class ResourcesComponentDestroySystem: DestroySystem<ResourcesComponent>
        {
            protected override void Destroy(ResourcesComponent self)
            {
                ...
                {
                    Node.Destroy(self.AssetBundleManifestObject);
        ...
        public static Node GetAsset(this ResourcesComponent self, string bundleName, string prefab)
        {
        ...
        private static void AddResource(this ResourcesComponent self, string bundleName, string assetName, Node resource)
        {
            Dictionary<string, Node> dict;
            if (!self.resourceCache.TryGetValue(bundleName.BundleNameToLower(), out dict))
            {
    ...
    public class ResourcesComponent: Entity, IAwake, IDestroy
    {
        ...
        public readonly Dictionary<string, Dictionary<string, Node>> resourceCache =
                new Dictionary<string, Dictionary<string, Node>>();
