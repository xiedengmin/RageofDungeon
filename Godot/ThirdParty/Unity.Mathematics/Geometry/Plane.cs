...
namespace Godot.Mathematics.Geometry
{
    /// <summary>
    ...
    internal struct Plane
    {
        ...
        {
            NormalAndDistance = Normalize(new Vector4(coefficientA, coefficientB, coefficientC, coefficientD));
        }
        ...
        {
            NormalAndDistance = Normalize(new Vector4(normal, distance));
        }
        ...
        /// <param name="pointInPlane">A point that lies in the plane.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Plane(Vector3 vector1InPlane, Vector3 vector2InPlane, Vector3 pointInPlane)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plane CreateFromUnitNormalAndDistance(Vector3 unitNormal, float distance)
        {
            return new Plane { NormalAndDistance = new Vector4(unitNormal, distance) };
        }
        ...
        /// <returns>Normalized Plane constructed from given inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Plane CreateFromUnitNormalAndPointInPlane(Vector3 unitNormal, Vector3 pointInPlane)
        {
            return new Plane { NormalAndDistance = new Vector4(unitNormal, -math.dot(unitNormal, pointInPlane)) };
        }
        ...
        /// </summary>
        /// <remarks>
        /// The plane coefficients are A, B, C, D and stored in that order in the <see cref="Vector4"/>.
        /// </remarks>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4 Normalize(Vector4 planeCoefficients)
        {
        ...
        public float SignedDistanceToPoint(Vector3 point)
        {
            ...
            return math.dot(NormalAndDistance, new Vector4(point, 1.0f));
        }
        ...
        /// <summary>
        /// Implicitly converts a <see cref="Plane"/> to <see cref="Vector4"/>.
        /// </summary>
        /// <param name="plane">Plane to convert.</param>
        /// <returns>A <see cref="Vector4"/> representing the plane.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Vector4(Plane plane) => plane.NormalAndDistance;
