...
namespace Godot.Mathematics
{
    ...
    public partial struct double2 : System.IEquatable<double2>, IFormattable
    {
        ...
        /// <summary>Constructs a double2 vector from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to double2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a Vector2 vector to a double2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to double2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2(Vector2 v) { return new double2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double2 vector constructed from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to double2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2 double2(Vector2 v) { return new double2(v); }
