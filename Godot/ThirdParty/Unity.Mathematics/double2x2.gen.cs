...
namespace Godot.Mathematics
{
    ...
    public partial struct double2x2 : System.IEquatable<double2x2>, IFormattable
    {
        ...
        /// <summary>Constructs a double2x2 matrix from a Vector2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x2 to convert to double2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x2(Vector2x2 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
        }
        ...
        /// <summary>Implicitly converts a Vector2x2 matrix to a double2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x2 to convert to double2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x2(Vector2x2 v) { return new double2x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double2x2 matrix constructed from a Vector2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x2 to convert to double2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x2 double2x2(Vector2x2 v) { return new double2x2(v); }
