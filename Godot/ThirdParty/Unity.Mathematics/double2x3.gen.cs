...
namespace Godot.Mathematics
{
    ...
    public partial struct double2x3 : System.IEquatable<double2x3>, IFormattable
    {
        ...
        /// <summary>Constructs a double2x3 matrix from a Vector2x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x3 to convert to double2x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x3(Vector2x3 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
            this.c2 = v.c2;
        ...
        /// <summary>Implicitly converts a Vector2x3 matrix to a double2x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x3 to convert to double2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x3(Vector2x3 v) { return new double2x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double2x3 matrix constructed from a Vector2x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x3 to convert to double2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x3 double2x3(Vector2x3 v) { return new double2x3(v); }
