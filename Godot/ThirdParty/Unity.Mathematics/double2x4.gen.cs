...
namespace Godot.Mathematics
{
    ...
    public partial struct double2x4 : System.IEquatable<double2x4>, IFormattable
    {
        ...
        /// <summary>Constructs a double2x4 matrix from a Vector2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x4 to convert to double2x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x4(Vector2x4 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
            this.c2 = v.c2;
        ...
        /// <summary>Implicitly converts a Vector2x4 matrix to a double2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x4(Vector2x4 v) { return new double2x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double2x4 matrix constructed from a Vector2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x4 to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x4 double2x4(Vector2x4 v) { return new double2x4(v); }
