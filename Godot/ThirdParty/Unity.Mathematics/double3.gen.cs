...
namespace Godot.Mathematics
{
    ...
    public partial struct double3 : System.IEquatable<double3>, IFormattable
    {
        ...
        /// <summary>Constructs a double3 vector from a Vector3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to double3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Implicitly converts a Vector3 vector to a double3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to double3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3(Vector3 v) { return new double3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double3 vector constructed from a Vector3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to double3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3 double3(Vector3 v) { return new double3(v); }
