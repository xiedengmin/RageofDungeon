...
namespace Godot.Mathematics
{
    ...
    public partial struct double3x2 : System.IEquatable<double3x2>, IFormattable
    {
        ...
        /// <summary>Constructs a double3x2 matrix from a Vector3x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x2 to convert to double3x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double3x2(Vector3x2 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
        }
        ...
        /// <summary>Implicitly converts a Vector3x2 matrix to a double3x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x2 to convert to double3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3x2(Vector3x2 v) { return new double3x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double3x2 matrix constructed from a Vector3x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x2 to convert to double3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3x2 double3x2(Vector3x2 v) { return new double3x2(v); }
