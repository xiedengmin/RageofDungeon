...
namespace Godot.Mathematics
{
    ...
    public partial struct double3x4 : System.IEquatable<double3x4>, IFormattable
    {
        ...
        /// <summary>Constructs a double3x4 matrix from a Vector3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x4 to convert to double3x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double3x4(Vector3x4 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
            this.c2 = v.c2;
        ...
        /// <summary>Implicitly converts a Vector3x4 matrix to a double3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x4 to convert to double3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double3x4(Vector3x4 v) { return new double3x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double3x4 matrix constructed from a Vector3x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x4 to convert to double3x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double3x4 double3x4(Vector3x4 v) { return new double3x4(v); }
