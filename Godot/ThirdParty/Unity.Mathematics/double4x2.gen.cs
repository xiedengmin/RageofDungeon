...
namespace Godot.Mathematics
{
    ...
    public partial struct double4x2 : System.IEquatable<double4x2>, IFormattable
    {
        ...
        /// <summary>Constructs a double4x2 matrix from a Vector4x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x2 to convert to double4x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double4x2(Vector4x2 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
        }
        ...
        /// <summary>Implicitly converts a Vector4x2 matrix to a double4x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x2 to convert to double4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x2(Vector4x2 v) { return new double4x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double4x2 matrix constructed from a Vector4x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x2 to convert to double4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x2 double4x2(Vector4x2 v) { return new double4x2(v); }
