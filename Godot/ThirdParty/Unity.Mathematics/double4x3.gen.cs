...
namespace Godot.Mathematics
{
    ...
    public partial struct double4x3 : System.IEquatable<double4x3>, IFormattable
    {
        ...
        /// <summary>Constructs a double4x3 matrix from a Vector4x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x3 to convert to double4x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double4x3(Vector4x3 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
            this.c2 = v.c2;
        ...
        /// <summary>Implicitly converts a Vector4x3 matrix to a double4x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x3 to convert to double4x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double4x3(Vector4x3 v) { return new double4x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a double4x3 matrix constructed from a Vector4x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x3 to convert to double4x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double4x3 double4x3(Vector4x3 v) { return new double4x3(v); }
