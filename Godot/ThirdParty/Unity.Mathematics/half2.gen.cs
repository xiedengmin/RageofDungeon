...
namespace Godot.Mathematics
{
    ...
    public partial struct half2 : System.IEquatable<half2>, IFormattable
    {
        ...
        /// <summary>Constructs a half2 vector from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to half2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Explicitly converts a Vector2 vector to a half2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to half2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator half2(Vector2 v) { return new half2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a half2 vector constructed from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to half2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static half2 half2(Vector2 v) { return new half2(v); }
