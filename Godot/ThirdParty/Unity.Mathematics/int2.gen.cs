...
namespace Godot.Mathematics
{
    ...
    public partial struct int2 : System.IEquatable<int2>, IFormattable
    {
        ...
        /// <summary>Constructs a int2 vector from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to int2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Explicitly converts a Vector2 vector to a int2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to int2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2(Vector2 v) { return new int2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int2 vector constructed from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to int2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2 int2(Vector2 v) { return new int2(v); }
