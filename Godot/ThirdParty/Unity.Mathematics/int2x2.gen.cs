...
namespace Godot.Mathematics
{
    ...
    public partial struct int2x2 : System.IEquatable<int2x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x2 matrix from a Vector2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x2 to convert to int2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x2(Vector2x2 v)
        {
            this.c0 = (int2)v.c0;
            this.c1 = (int2)v.c1;
        }
        ...
        /// <summary>Explicitly converts a Vector2x2 matrix to a int2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x2 to convert to int2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x2(Vector2x2 v) { return new int2x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int2x2 matrix constructed from a Vector2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x2 to convert to int2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x2 int2x2(Vector2x2 v) { return new int2x2(v); }
