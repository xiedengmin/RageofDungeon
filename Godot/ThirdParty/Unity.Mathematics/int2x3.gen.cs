...
namespace Godot.Mathematics
{
    ...
    public partial struct int2x3 : System.IEquatable<int2x3>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x3 matrix from a Vector2x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x3 to convert to int2x3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x3(Vector2x3 v)
        {
            this.c0 = (int2)v.c0;
            this.c1 = (int2)v.c1;
            this.c2 = (int2)v.c2;
        ...
        /// <summary>Explicitly converts a Vector2x3 matrix to a int2x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x3 to convert to int2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x3(Vector2x3 v) { return new int2x3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int2x3 matrix constructed from a Vector2x3 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x3 to convert to int2x3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x3 int2x3(Vector2x3 v) { return new int2x3(v); }
