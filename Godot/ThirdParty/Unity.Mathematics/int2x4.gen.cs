...
namespace Godot.Mathematics
{
    ...
    public partial struct int2x4 : System.IEquatable<int2x4>, IFormattable
    {
        ...
        /// <summary>Constructs a int2x4 matrix from a Vector2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x4 to convert to int2x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int2x4(Vector2x4 v)
        {
            this.c0 = (int2)v.c0;
            this.c1 = (int2)v.c1;
            this.c2 = (int2)v.c2;
        ...
        /// <summary>Explicitly converts a Vector2x4 matrix to a int2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int2x4(Vector2x4 v) { return new int2x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int2x4 matrix constructed from a Vector2x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector2x4 to convert to int2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int2x4 int2x4(Vector2x4 v) { return new int2x4(v); }
