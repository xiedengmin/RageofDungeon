...
namespace Godot.Mathematics
{
    ...
    public partial struct int3 : System.IEquatable<int3>, IFormattable
    {
        ...
        /// <summary>Constructs a int3 vector from a Vector3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to int3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Explicitly converts a Vector3 vector to a int3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to int3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int3 vector constructed from a Vector3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to int3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 int3(Vector3 v) { return new int3(v); }
