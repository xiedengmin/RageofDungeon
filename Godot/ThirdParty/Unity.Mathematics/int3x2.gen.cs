...
namespace Godot.Mathematics
{
    ...
    public partial struct int3x2 : System.IEquatable<int3x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int3x2 matrix from a Vector3x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x2 to convert to int3x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int3x2(Vector3x2 v)
        {
            this.c0 = (int3)v.c0;
            this.c1 = (int3)v.c1;
        }
        ...
        /// <summary>Explicitly converts a Vector3x2 matrix to a int3x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x2 to convert to int3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int3x2(Vector3x2 v) { return new int3x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int3x2 matrix constructed from a Vector3x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector3x2 to convert to int3x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3x2 int3x2(Vector3x2 v) { return new int3x2(v); }
