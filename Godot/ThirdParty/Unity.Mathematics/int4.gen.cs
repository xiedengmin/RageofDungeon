...
namespace Godot.Mathematics
{
    ...
    public partial struct int4 : System.IEquatable<int4>, IFormattable
    {
        ...
        /// <summary>Constructs a int4 vector from a Vector4 vector by componentwise conversion.</summary>
        /// <param name="v">Vector4 to convert to int4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Explicitly converts a Vector4 vector to a int4 vector by componentwise conversion.</summary>
        /// <param name="v">Vector4 to convert to int4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4(Vector4 v) { return new int4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int4 vector constructed from a Vector4 vector by componentwise conversion.</summary>
        /// <param name="v">Vector4 to convert to int4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4 int4(Vector4 v) { return new int4(v); }
