...
namespace Godot.Mathematics
{
    ...
    public partial struct int4x2 : System.IEquatable<int4x2>, IFormattable
    {
        ...
        /// <summary>Constructs a int4x2 matrix from a Vector4x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x2 to convert to int4x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4x2(Vector4x2 v)
        {
            this.c0 = (int4)v.c0;
            this.c1 = (int4)v.c1;
        }
        ...
        /// <summary>Explicitly converts a Vector4x2 matrix to a int4x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x2 to convert to int4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x2(Vector4x2 v) { return new int4x2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int4x2 matrix constructed from a Vector4x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x2 to convert to int4x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4x2 int4x2(Vector4x2 v) { return new int4x2(v); }
