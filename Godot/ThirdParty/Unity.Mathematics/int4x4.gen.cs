...
namespace Godot.Mathematics
{
    ...
    public partial struct int4x4 : System.IEquatable<int4x4>, IFormattable
    {
        ...
        /// <summary>Constructs a int4x4 matrix from a Vector4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x4 to convert to int4x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int4x4(Vector4x4 v)
        {
            this.c0 = (int4)v.c0;
            this.c1 = (int4)v.c1;
            this.c2 = (int4)v.c2;
        ...
        /// <summary>Explicitly converts a Vector4x4 matrix to a int4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x4 to convert to int4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int4x4(Vector4x4 v) { return new int4x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a int4x4 matrix constructed from a Vector4x4 matrix by componentwise conversion.</summary>
        /// <param name="v">Vector4x4 to convert to int4x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int4x4 int4x4(Vector4x4 v) { return new int4x4(v); }
