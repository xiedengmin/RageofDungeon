...
namespace Godot.Mathematics
{
    ...
    public partial struct uint2 : System.IEquatable<uint2>, IFormattable
    {
        ...
        /// <summary>Constructs a uint2 vector from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to uint2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint2(Vector2 v)
        {
            this.x = (uint)v.x;
            this.y = (uint)v.y;
        }
        ...
        /// <summary>Explicitly converts a Vector2 vector to a uint2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to uint2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint2(Vector2 v) { return new uint2(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a uint2 vector constructed from a Vector2 vector by componentwise conversion.</summary>
        /// <param name="v">Vector2 to convert to uint2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint2 uint2(Vector2 v) { return new uint2(v); }
