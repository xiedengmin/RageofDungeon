...
namespace Godot.Mathematics
{
    ...
    public partial struct uint3 : System.IEquatable<uint3>, IFormattable
    {
        ...
        /// <summary>Constructs a uint3 vector from a Vector3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to uint3</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint3(Vector3 v)
        {
            this.x = (uint)v.x;
            this.y = (uint)v.y;
            this.z = (uint)v.z;
        ...
        /// <summary>Explicitly converts a Vector3 vector to a uint3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to uint3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint3(Vector3 v) { return new uint3(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a uint3 vector constructed from a Vector3 vector by componentwise conversion.</summary>
        /// <param name="v">Vector3 to convert to uint3</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint3 uint3(Vector3 v) { return new uint3(v); }
