...
namespace Godot.Mathematics
{
    ...
    public partial struct uint4 : System.IEquatable<uint4>, IFormattable
    {
        ...
        /// <summary>Constructs a uint4 vector from a Vector4 vector by componentwise conversion.</summary>
        /// <param name="v">Vector4 to convert to uint4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint4(Vector4 v)
        {
            this.x = (uint)v.x;
            this.y = (uint)v.y;
            this.z = (uint)v.z;
        ...
        /// <summary>Explicitly converts a Vector4 vector to a uint4 vector by componentwise conversion.</summary>
        /// <param name="v">Vector4 to convert to uint4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator uint4(Vector4 v) { return new uint4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Return a uint4 vector constructed from a Vector4 vector by componentwise conversion.</summary>
        /// <param name="v">Vector4 to convert to uint4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint4 uint4(Vector4 v) { return new uint4(v); }
