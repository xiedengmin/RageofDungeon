...
public static class StateMachineShortcuts {
    /*
        ...
        - They can also optimize certain cases for you by choosing the best type,
    ...
    */
    ...
    /// <param name="afterTransition"></param>
    ...
    private static TransitionBase<TStateId> CreateOptimizedTransition<TStateId>(
        ...
        return condition == null && onTransition == null && afterTransition == null
                ? new TransitionBase<TStateId>(from, to, forceInstantly)
