...
{
	private Color pressedColor = Colors.Gray;
	//[Export(PropertyHint.Range, "0,200,1")] 
	private float deadZoneSize = 5;
	//[Export(PropertyHint.Range, "0,500,1")] 
	private float clampZoneSize = 30;
	enum JoyStickMode
	{
	...
	//[Export] 
	private bool useInputActions = true;
	//[Export]
	private string actionLeft = "ui_left";
	//[Export] 
	private string actionRight = "ui_right";
	//[Export]
	private string actionUp = "ui_up";
	//[Export]
	private string actionDown = "ui_down";
