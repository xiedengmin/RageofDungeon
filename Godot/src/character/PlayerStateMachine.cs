...
namespace ET
{
    ...
    {
        // Declare nodes
        private NodePath idlePath = "Idle";
        private NodePath movePath = "Move";
        private NodePath punchPath = "Punch";
        private NodePath jumpPath = "Jump";
        private NodePath damagePath = "Damage";
        private NodePath attackPath = "Attack";
