...
namespace ET
{
    public partial class Jump : Motion
    {
        ...
        public float baseMaxHorizontalSpeed = 400.0f;
        public float airAcceleration = 1000.0f;
        public float airDeceleration = 2000.0f;
        public float airSteeringPower = 50.0f;
        public float gravity = 1600.0f;
