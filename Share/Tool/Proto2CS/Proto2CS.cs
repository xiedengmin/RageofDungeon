...
namespace ET
{
    ...
    {
        private const string protoDir = "../Godot/Config/Proto";
        private const string clientMessagePath = "../Godot/Model/Generate/Client/Message/";
        private const string serverMessagePath = "../Godot/Model/Generate/Server/Message/";
        private const string clientServerMessagePath = "../Godot/Model/Generate/ClientServer/Message/";
